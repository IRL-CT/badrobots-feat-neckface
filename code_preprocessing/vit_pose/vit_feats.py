...
if __name__ == '__main__':
    ...
    video_path = '../../data/final_study_data_BGR_30fps'
    ...
    for frames_folder in video_files:
        ...
        if os.path.exists(f'../../data/vit_features/{frames_folder}.h5'):
        ...
        frames = []
        #two frames folders, 0 and 1
        frames_folds = os.listdir(f'{video_path}/{frames_folder}/frames/')
        for frame_fold in frames_folds:
            frames_files = os.listdir(f'{video_path}/{frames_folder}/frames/{frame_fold}')
            for frame_file in frames_files:
                frame = cv2.imread(f'{video_path}/{frames_folder}/frames/{frame_fold}/{frame_file}')
                frames.append(frame)
                #stop at frame 100
                #if len(frames) == 100:
                #    break
        ...
        print(frames.shape)
        metadata = processor.process_frames(frames, f'../../data/vit_features/{frames_folder}.h5')
